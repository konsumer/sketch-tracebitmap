...
Potrace.prototype = {
   ...
   */
  loadImage: function (imageLayer, callback) {
    this._imageLoadingIdentifier = {}
    this._imageLoaded = false

    // use sketch stuff to get image from layer
    ...
    const data = imageLayer.image().data() + ''

    // Emulate Jimp
    const img = { bitmap: { data, height, width } }

    this._imageLoadingIdentifier = null
    this._processLoadedImage(img)
